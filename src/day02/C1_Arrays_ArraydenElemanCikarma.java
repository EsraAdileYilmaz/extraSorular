...
public class C1_Arrays_ArraydenElemanCikarma {
    public static void main(String[] args) {

        //Huseyin belgique yapti
    ...
    public static int[] arraydenElamanCikar(int[] array, int sayi) {
        ...
        for (int i = 0; i < index; i++) {
            ...
            // Cikaracagimiz sayidan onceki elemanlarin yeri yeni arrayde degismez. O sebeple eski arraydeki ayni indexe yazabilriz.
            yeniArray[i] = array[i];
        }
